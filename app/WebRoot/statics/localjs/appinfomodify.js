function  loadCategoryLevel2(pid,cl,categoryLevel){
	$.ajax({
		type:"GET",//请求类型
		url:ctx+"/sys/devindex/categorylevellist.json",//请求的url
		data:{pid:pid},//请求参数
...
function  loadCategoryLevel(pid,cl,categoryLevel){
	$.ajax({
		type:"GET",//请求类型
		url:ctx+"/sys/devindex/categorylevellist1.json",//请求的url
...
$(function(){  
	...
	$.ajax({
		type:"GET",//请求类型
		url:ctx+"/sys/devindex/sysdatadictionarylist.json",//请求的url
	...
	//动态加载二级分类列表
	loadCategoryLevel2(cl1,cl2,"categoryLevel2");
	//动态加载三级分类列表
	loadCategoryLevel2(cl2,cl3,"categoryLevel3");
	
	//联动效果：动态加载二级分类列表
	$("#categoryLevel1").change(function(){
		var categoryLevel1 = $("#categoryLevel1").val();
		if(categoryLevel1 != '' && categoryLevel1 != null){
			loadCategoryLevel2(categoryLevel1,null,"categoryLevel2");
		}else{
			$("#categoryLevel2").html("");
			var options = "<option value=\"-1\">--请选择--</option>";
	...
	$("#categoryLevel2").change(function(){
		...
		if(categoryLevel2 != '' && categoryLevel2 != null){
			loadCategoryLevel2(categoryLevel2,null,"categoryLevel3");
		}else{
			$("#categoryLevel3").html("");
			var options = "<option value=\"-1\">--请选择--</option>";
			$("#categoryLevel3").html(options);

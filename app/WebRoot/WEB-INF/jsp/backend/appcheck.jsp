  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/sys/backend/checksave" method="post">
        ...
        <form class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" value="${appInfo.appVersion.versionSize }" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              ${appInfo.appVersion.versionInfo }</textarea>
            </div>
          </div>
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <c:choose> 
			  <c:when test="${appInfo.appVersion.downloadLink == null || appInfo.appVersion.downloadLink == ''}">   
			    	暂无
			  </c:when> 
			  <c:otherwise>   
			    <p>${appInfo.appVersion.apkFileName}&nbsp;&nbsp;
			    <a href="${appInfo.appVersion.downloadLink}" >下载</a>
			    </p>
			  </c:otherwise> 
            </c:choose> 
            </div>

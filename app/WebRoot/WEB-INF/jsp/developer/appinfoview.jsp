    ...
    <div class="x_panel">
      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" >
          <input type="hidden" name="id" value="${appInfoandversion.id}">
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">软件名称 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" value="${appInfoandversion.softwareName}" 
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              value="${appInfoandversion.APKName}" readonly="readonly">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" 
              	value="${appInfoandversion.supportROM}" type="text" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" readonly="readonly"
              	value="${appInfoandversion.interfaceLanguage}" type="text">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" value="${appInfoandversion.softwareSize}"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" value="${appInfoandversion.downloads}"
               class="form-control col-md-7 col-xs-12" readonly="readonly">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${appInfoandversion.flatformName}" readonly="readonly">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${appInfoandversion.categoryLevel1Name} --> ${appInfoandversion.categoryLevel2Name} --> ${appInfoandversion.categoryLevel3Name}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            	<input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${appInfoandversion.statusName}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              ${appInfoandversion.appInfo}</textarea>
            </div>
          </div>
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
			 <c:choose> 
				  <c:when test="${appInfoandversion.logoPicPath == null || appInfoandversion.logoPicPath == ''}">   
				    	暂无
				  </c:when> 
				  <c:otherwise>   
				    <img src="/${appInfoandversion.logoPicPath}?m=1" width="100px;"/> 
				  </c:otherwise> 
              </c:choose> 
            </div>
          </div>
